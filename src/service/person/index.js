...
export const getPersonas = async () => {
  ...
  export const getPersonasById = async (id) => {
    try {
      const response = await fetch(`${URL}/GetPersonasById/${id}`, METHOD.GET());
      const data = await response.json();
      return data;
    } catch (err) {
      console.log(err);
  ...
  export const getPersonasByFiltros = async (tipodoc, numdoc) => {
    try {
      const response = await fetch(`${URL}/GetPersonasByFiltros/${tipodoc}/${numdoc}`, METHOD.GET());
      const data = await response.json();
      return data;
    } catch (err) {
      console.log(err);
